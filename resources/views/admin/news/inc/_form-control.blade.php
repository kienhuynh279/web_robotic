<x-wp-layout>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <input type="text" class="form-control @error("Image") is-invalid @enderror" id="Image" name="Image"
                placeholder="Hình ảnh" value="{{!old("Image") ? $news->Image ?? false ? $news->Image : old("Image") : old("Image") }}">
    ...
    <div class="form-group">
        ...
        <textarea id="editor" class="form-control" name="Description" rows="3">{{!old("Description") ? $news->Description ?? false ? $news->Description : old("Description") : old("Description") }}</textarea>
    </div>
