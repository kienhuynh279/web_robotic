...
<div class="content">
    <div class="row row-deck">
        <div class="col-6 col-lg-3">
            <a class="block block-rounded block-link-shadow text-center" href="{{route("admin.categories.create")}}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="d-none d-md-table-cell text-center font-size-sm">
                                <a class="font-w600" href="#">{{$category->Title}}</a>
                            </td>
                            ...
                            <td class="text-center font-size-sm">
                                ...
                                <form class="d-none" id="action-destroy-{{$category->CategoryId}}" action="{{route("admin.categories.destroy", $category->CategoryId)}}" method="POST">
                                    @csrf
                                    @method("DELETE")
                                </form>
