            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-xs-4">
                        <div class="top-number"><p><i class="fa fa-phone-square"></i> 0913 681353 – 0778 805 117 - (+84) 366 818 469 | <i class="fas fa-envelope"></i> minh.do@arra.vn </p></div>
                    </div>
        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ asset('assets/client/images/logo_.png') }}" alt="logo"></a>
                </div>
