            ...
            <div class="row">
                <div class="col-sm-2 sm-margin-b-30">
                    ...
                    <ul class="list-unstyled footer-list">
                        ...
                        <li class="footer-list-item"><a href="#">Service</a></li>
                ...
                <div class="col-sm-2 sm-margin-b-30">
                    <!-- List -->
                    <ul class="list-unstyled footer-list">
                        <li class="footer-list-item"><a href="#">Phone</a></li>
                        <li class="footer-list-item"><a href="#">Gmail</a></li>
        ...
        <div class="row">
            ...
            <div class="col-xs-6 text-right">
                <p class="margin-b-0"><a class="fweight-700" href="#">Copyright</a>
                    Theme Powered by: <a class="fweight-700" href="#">Developer</a></p>
            </div>
        </div>
        <!--// end row -->
    </div>
